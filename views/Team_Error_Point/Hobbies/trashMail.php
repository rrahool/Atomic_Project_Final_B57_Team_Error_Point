        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="w3-bar w3-border w3-light-grey">
                    ...
                    <a href="index.php" class="w3-bar-item w3-button" style="text-decoration: none">Hobbies List</a>
    ...
    <div class="col-md-10">
        ...
        <form  role="form" method="post" action="trashMail.php<?php if(isset($_REQUEST['id'])) echo "?id=".$_REQUEST['id']; else echo "?list=1";?>">
            <div class="form-group">
                ...
                <input type="text"  name="subject"  class="form-control" id="subject" value="<?php if($list){echo "List of hobbie(s) recommendation";} else {echo "A single hobbie(s) recommendation";} ?>">
...
{
    printf("Trashed Item: [<strong>Hobbies ID: </strong>%s, <strong>Name: </strong>%s, <strong>Hobbies: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->hobbies);
