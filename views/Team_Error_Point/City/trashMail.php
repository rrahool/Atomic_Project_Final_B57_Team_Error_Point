...
if($list){
    ...
    foreach($recordSet as $row) {
        ...
        $sl++;
        printf("<tr><td width='50'>%d</td><td width='50'>%d</td><td width='450'>%s</td><td width='550'>%s</td></tr>",$sl,$id,$name,$city);
...
{
    printf("Trashed Item: [<strong>City ID: </strong>%s, <strong>Name: </strong>%s, <strong>City: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->city);
