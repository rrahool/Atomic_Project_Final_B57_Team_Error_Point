...
{
    printf("Trashed Item: [<strong>ProfilePicture ID: </strong>%s, <strong>Name: </strong>%s, <strong>ProfilePicture: </strong>%s]",$singleItem->id,$singleItem->name,$singleItem->profile_picture);
