        ...
        <div class="row">
            ...
            <div class="col-md-7">
                <div class="w3-bar w3-border w3-light-grey">
                    <a href="create.php" class="w3-bar-item w3-button" style="text-decoration: none">Add ProfilePicture</a>
                    <a href="index.php" class="w3-bar-item w3-button" style="text-decoration: none">ProfilePicture List</a>
    ...
    <div class="col-md-10">
        ...
        <form  role="form" method="post" action="trashMail.php<?php if(isset($_REQUEST['id'])) echo "?id=".$_REQUEST['id']; else echo "?list=1";?>">
            <div class="form-group">
                ...
                <input type="text"  name="subject"  class="form-control" id="subject" value="<?php if($list){echo "List of profile pictures recommendation";} else {echo "A single profile picture recommendation";} ?>">
...
if($list){
    ...
    printf("<table><tr> <td width='50'><strong>Serial</strong></td><td width='50'><strong>ID</strong></td><td width='250'><strong>Name</strong></td><td width='250'><strong>ProfilePicture</strong></td></tr>");
...
{
    printf("Trashed Item: [<strong>ProfilePicture ID: </strong>%s, <strong>Name: </strong>%s, <strong>ProfilePicture: </strong><img src='Images/%s' height='50px;'  width='50px;'>]",$singleItem->id,$singleItem->name,$singleItem->profile_picture);
