    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="w3-bar w3-border w3-light-grey">
                <a href="create.php" class="w3-bar-item w3-button" style="text-decoration: none">Add Profile Picture</a>
                <a href="index.php" class="w3-bar-item w3-button w3-black" style="text-decoration: none">Profile Picture List</a>
                ...
                <div class="col-sm-6">
                    <div class="w3-panel">
                        <form id="searchForm" action="index.php"  method="get">
                            ...
                            <label> By Name</label>
                            <input class="w3-check" type="checkbox" name="byProfilePicture" checked="checked">
                            <label> By Profile Picture</label>
