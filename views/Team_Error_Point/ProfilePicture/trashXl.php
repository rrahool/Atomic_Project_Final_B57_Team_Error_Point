...
// Miscellaneous glyphs, UTF-8
    $objPHPExcel->setActiveSheetIndex(0)
        ...
        ->setCellValue('D' . $counter, "<img src='Images/$row->profile_picture' height='30px;' width='30px;'>");
...
header('Content-Disposition: attachment;filename="ProfilePicture - TrashList.xlsx"');
